Pod::Spec.new do |s|
  ...
  s.source           = { :path => '.' }
  # Swift/ObjC/C++ sources from all subdirectories.
  ...
  s.pod_target_xcconfig = {
    ...
    'HEADER_SEARCH_PATHS'                                   => '$(inherited) "${PODS_ROOT}/OpenCV2/opencv2.framework/Headers" "${PODS_TARGET_SRCROOT}/Classes/Core" "${PODS_TARGET_SRCROOT}/Classes"',
    'USER_HEADER_SEARCH_PATHS'                              => '"${PODS_TARGET_SRCROOT}/Classes/Core"',
